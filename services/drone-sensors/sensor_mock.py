...
class SensorMock:
    ...
    def read(self):
        ...
        [altitude (0..1), front_dist (0..2), shift_x (-1..1), shift_y (-1..1), velocity_x (-1..1), velocity_y (-1..1)]
        """
        t = time.time() - self.start_time
        
        # Simulate some oscillatory movement
        altitude = (math.sin(t * 0.5) + 1) / 2.0  # 0 to 1
        front_dist = (math.cos(t * 0.4) + 1.0)    # 0 to 2
        ...
        return [
            ...
            max(0.0, min(2.0, front_dist + noise())),
